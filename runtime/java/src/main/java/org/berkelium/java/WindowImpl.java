...
public class WindowImpl implements org.berkelium.java.Window {
	...
	public native Widget getWidget();
	...
	public native Widget getWidgetAtPoint(int xPos, int yPos, boolean returnRootIfOutside);
	...
	public native void synchronousScriptReturn(Object handle, Variant result);

	public native void bind(String lvalue, Variant rvalue);

	public native void addBindOnStartLoading(String lvalue, Variant rvalue);
